...
module.exports = class Scraper {
  static async scrape(url, hostname, html) {
    switch (hostname) {
      case 'www.athome.co.jp':
        return this.parseAtHome(url, html)
      case 'suumo.jp':
        return this.parseSuumo(url, html)
      case 'realestate.yahoo.co.jp':
        return this.parseYahoo(url, html)
      case 'www.realtokyoestate.co.jp':
        return this.parseRealTokyoEstate(url, html)
      case 'tokyo-style.cc':
        return this.parseTokyoStyle(url, html)
      case 'www.aeras-group.jp':
        return this.parseAerasGroup(url, html)
      case 'www.rehouse.co.jp':
        return this.parseRehouse(url, html)
      case 'www.renov-depart.jp':
        return this.parseRenovDepart(url, html)
      case 'www.chintai.net':
        return this.parseChintai(url, html)
      case 'www.omusubi-estate.com':
        return this.parseOmusubiEstate(url, html)
      case 'www.r-store.jp':
        return this.parseRStore(url, html)
      case 'www.tatodesign.jp':
        return this.parseTatoDesign(url, html)
      case 'www.goodrooms.jp':
        return this.parseGoodroom(url, html)
      case 'www.homes.co.jp':
        return this.parseLifullHomes(url, html)
      case 'joylifestyle.jp':
        return this.parseJoylifestyle(url, html)
      case 'www.diyp.jp':
        return this.parseDiyp(url, html)
      case 'www.pethomeweb.com':
        return this.parsePetHomeWeb(url, html)
      case 'xn--ihqxo86hrls96efnv.com':
        return this.parseBunkyoku(url, html)
      case 'tomigaya.jp':
        return this.parseTomigaya(url, html)
      ...
      case 'kagurazaka-fudousan.com':
        return this.parseTomigaya(url, html)
      case 'www.jkhome.com':
        return this.parseJKHome(url, html)
      case 'kodate.chintaistyle.jp':
        return this.parseKodateChintai(url, html)
      case 'house.asocio.co.jp':
        return this.parseHouseAsocio(url, html)
      case 'house.goo.ne.jp':
        return this.parseHouseGoo(url, html)
      case 'spacelist.jp':
        return this.parseSpacelist(url, html)
      case 'housestokyo.jp':
        return this.parseHousesTokyo(url, html)
      case 'sumaity.com':
        return this.parseSumaity(url, html)
      case 'www.kencorp.co.jp':
        return this.parseKenCorp(url, html)
      case 'www.bestexnet.co.jp':
        return this.parseBestex(url, html)
      case 'smocca.jp':
        return this.parseSmocca(url, html)
      case 'www.axel-home.com':
        return this.parseAxelHome(url, html)
      case 'chintai-ex.jp':
        return this.parseChintaiEx(url, html)
      case 'www.hatomarksite.com':
        return this.parseHatomarkSite(url, html)
      case 'www.century21.jp':
        return this.parseCentury21(url, html)
      case 'house.ocn.ne.jp':
        return this.parseHouseOCN(url, html)
      case 'www.oasis-estate.jp':
        return this.parseOasisEstate(url, html)
      default:
        return null
    }
  }

  static async parseAtHome(url, html) {
  ...
  static async parseSuumo(url, html) {
    const $ = cheerio.load(html)
  ...
  static async parseYahoo(url, html) {
    const $ = cheerio.load(html)
  ...
  static async parseRealTokyoEstate(url, html) {
    const $ = cheerio.load(html)
  ...
  static async parseTokyoStyle(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseAerasGroup(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseRehouse(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
    ...
    output.listing.security_deposit = $('th:contains("敷金／礼金／保証金") + td')
      ...
      .match(/(\d+)/g)[0]
    output.listing.square_m = $(
      'th:contains("専有面積")+ td, th:contains("建物面積") + td'
    )
      .first()
      .text()
      .replace('㎡', '')
  ...
  static async parseRenovDepart(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseChintai(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseOmusubiEstate(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
    ...
    if (monthlyRent === '') {
      output.listing.monthly_rent = $('dt:contains("価格") + dd')
        .text()
        .replace('万円', '')
    } else {
  ...
  static async parseRStore(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseTatoDesign(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseGoodroom(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
    ...
    output.listing.availability = '募集中'
    output.listing.monthly_rent =
      parseInt($('th:contains("家賃") + td').text().replace('円', '').replace(',', '')) /
      10000
  ...
  static async parseLifullHomes(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseJoylifestyle(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseDiyp(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parsePetHomeWeb(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseBunkyoku(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseTomigaya(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseJKHome(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseKodateChintai(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseHouseAsocio(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseHouseGoo(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseSpacelist(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseSumaity(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseKenCorp(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseBestex(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseSmocca(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseAxelHome(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseHousesTokyo(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseChintaiEx(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseHatomarkSite(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseCentury21(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseHouseOCN(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
  ...
  static async parseOasisEstate(url, html) {
    const $ = cheerio.load(html)
    const output = cloneDeep(dataStruct)
