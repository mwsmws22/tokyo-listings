...
| `GOOGLE_MAPS_API_KEY_SERVER` | IP-restricted key for Geocoding API (API service only) |
| `GOOGLE_MAPS_API_KEY_CLIENT` | HTTP-referrer–restricted key for Maps JavaScript API (`next.config.ts` inlines for the web app) |
